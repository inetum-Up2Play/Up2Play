...
public class NotificacionService {
    ...
    public List<NotificacionDtoResp> getNotificacionesUsuario(Long usuarioId) {
        ...
        return usuario.getUsuarioNotificaciones().stream().map(n -> new NotificacionDtoResp(
                ...
                n.getNotificacion().getFecha() != null ? n.getNotificacion().getFecha().toString() : null,
                n.isLeido(),
    ...
    public Boolean Leer(Long id, Long usuarioId) {
        ...
        UsuarioNotificacion usuarioNotificacion = usuarioNotificacionRepository.findByUsuarioAndNotificacion(usuario,
                notificacion);
