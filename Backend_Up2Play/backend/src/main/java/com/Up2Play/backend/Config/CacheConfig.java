...
@Configuration
@EnableCaching // activa el soporte de caché en Spring. Esto permite usar anotaciones como
               // @Cacheable, @CachePut, @CacheEvict.
public class CacheConfig {

    // Se define y configura el objeto "Caffeine" que se utilizará en el metodo de
    // abajo
    @Bean
    ...
    // Este método define el gestor de caché principal, donde recoge el objeto
    // Caffeine de arriba
    @Bean
